...
/* write to modbus */
int write_modbus( uint8_t * , int );


/* read from modbus line (RS485) */
int read_modbus( uint8_t * , int );

/* modbus read input bits */
int modbus_RIB( int16_t , int, uint8_t * );


/* modbus write input bits */
int modbus_WIB( uint16_t , int , uint8_t * );


/* Write the values from the array to the registers of the remote device */
int modbus_WR( int , int , const uint16_t *);

/* Read the values from the array to the registers of the remote device */
int modbus_RR( int , int , uint16_t *);

void modbusMOTOR_task(void *);
